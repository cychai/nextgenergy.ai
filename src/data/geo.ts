...
export const faqs: Record<string, FaqItem[]> = {
  ...
  '/approach/return-water': [
    { q: 'Who can buy data-centre waste heat, and what temperature do they need?', a: 'Buyers are sorted by the supply temperature they need, not by how much heat you have. Greenhouses and fourth-generation district heating typically need 45 °C or more (4GDH is defined around 50–60 °C supply, up to 70 °C in winter); swimming pools, aquaculture and heat-pump sources can take less. A cold-plate loop returning around 55 °C at rated IT load can serve the lower end of that window directly, once the export heat-exchanger approach is subtracted and if the network runs at fourth-generation temperatures; warmer networks and the winter end of the range need a heat pump for the last few kelvin. A 30 °C loop needs a heat pump for almost all of them.', href: '/tools/return-water', label: 'Check your own return temperature' },
