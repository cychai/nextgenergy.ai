...
export const claims: Record<string, Claim> = {
  ...
  'deployed-1000mw': {
    ...
    statement: 'Nearly 1,000 MW of liquid cooling has been deployed on the product platform our founding team built.',
    condition: 'Cumulative liquid-cooling capacity shipped on the product platform the founding team built at Tsingchain Technology, 2018–2026, before NextGenergy; company records of shipped capacity, not a NextGenergy installed base.',
  ...
  'founding-8-years': {
    ...
    condition: 'Counted from the founding of Tsingchain Technology (Beijing) in 2018, where the founding team built immersion and then direct-to-chip systems, to 2026. Describes the team\'s experience, not NextGenergy, which was incorporated in 2025.',
